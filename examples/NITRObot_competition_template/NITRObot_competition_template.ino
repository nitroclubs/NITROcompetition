...
// Download and install the library from https://github.com/nitroclubs/NITROcompetition.git 
...
void loop()
{
    ...
    if (competition.getStartSignal() == true)
    {
        /*
         ...
         It will be executed when the NITROcompetition library gets the start signal from the server
        */
